// Baked GitHub star count. Updated at build time by scripts/fetch-stars.mjs
// (npm `prebuild`). Committed default is the last-known value; the client
